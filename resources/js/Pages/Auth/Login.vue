<template>
    ...
    <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
            ...
            <a href="auth/facebook" class="mt-4 bg-blue-600 text-white w-full p-2 flex flex-row justify-center gap-2 items-center hover:bg-blue-700 duration-100 ease-in-out">
